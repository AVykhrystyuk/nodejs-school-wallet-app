...
function isCardNumberValid(cardNumber) {
    cardNumber = typeof cardNumber === 'string' ? cardNumber : cardNumber.toString();
    const cardDigits = Array.from(cardNumber).map(c => Number(c));
...
module.exports = {
    isCardDigitsValid: isCardDigitsValid,
